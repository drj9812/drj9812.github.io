...
![01-oracle-homepage](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/01-oracle-homepage.jpg)
...
![02-download-source-code](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/02-download-source-code.jpg)
*<https://github.com/oracle-samples/db-sample-schemas/releases/tag/v23.3>{: target="_blank" } 접속 > `Source code (zip)`*

![03-select-schema-folder](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/03-select-schema-folder.jpg)
...
![04-move-schema-folder](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/04-move-schema-folder.jpg)
...
![05-connect-as-admin](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/05-connect-as-admin.jpg)
*관리자 수준으로 접속*
...
![06-change-session](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/06-change-session.jpg)
...
![07-run-hr_install.sql](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/07-run-hr_install.sql.jpg)
...
![08-installation](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/08-installation.jpg)
*설치 완료*

### 접속

![09-succed-test](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/09-succed-test.jpg)
*테스트 성공*
...
![10-check-installation.jpg](/assets/img/posts/tools/db/oracle/install-sample-schema-on-windows/10-check-installation.jpg)
