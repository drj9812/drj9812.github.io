...
![01-chirpy-getting-started(1)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/01-chirpy-getting-started(1).png)
...
![02-jekyll-docs](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/02-jekyll-docs.png)
...
![03-download-ruby](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/03-download-ruby.png)
...
![04-install-ruby(1)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/04-install-ruby(1).png)
*`rubyinstaller-devkit-3.2.2-1-x86.exe` 파일 실행 > `Install for me only (recommended)`*

![05-install-ruby(2)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/05-install-ruby(2).png)
*`I accept the Lincense` 체크 > `Next`*

![06-install-ruby(3)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/06-install-ruby(3).png)
...
![07-install-ruby(4)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/07-install-ruby(4).png)
...
![08-install-ruby(5)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/08-install-ruby(5).png)
*`Run 'ridk install' to setup MSYS2 and development toolchain. MSYS2 is required to install gems with C extensions.` 체크 > `Finish`*

![09-install-ruby(6)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/09-install-ruby(6).png)
*`Enter`*

![10-install-ruby(7)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/10-install-ruby(7).png)
*`Enter`*

### Node.js 설치

<a id=anchor1></a>
![11-chirpy-getting-started(2)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/11-chirpy-getting-started(2).png)
...
![12-node-homepage](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/12-node-homepage.png)
*[Node.js 홈페이지](https://nodejs.org/en){: target="_blank" } > `20.11.0 LTS` 다운로드*

![13-install-node(1).=](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/13-install-node(1).png)
*`node-v20.11.0-x64.msi` 파일 실행 > `Next`*

![14-install-node(2)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/14-install-node(2).png)
*`I accept the terms in the License Agreement` 체크 > `Next`*

![15-install-node(3)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/15-install-node(3).png)
*`Next`*

![16-install-node(4)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/16-install-node(4).png)
*`Next`*

![17-install-node(5)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/17-install-node(5).png)
...
![18-install-node(6)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/18-install-node(6).png)
*`Install`*

![19-install-node(7)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/19-install-node(7).png)
*`Finish`*

![20-install-node(8)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/20-install-node(8).png)
*`Enter`*

![21-install-node(9)](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/21-install-node(9).png)
*`Enter`*
...
![22-check-version](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/22-check-version.png)

2024년 01월 19일을 기준으로 저의 환경은 위와 같습니다.

## jekyll-theme-chirpy Repository Fork

![23-fork-repo](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/23-fork-repo.png)
...
![24-create-fork](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/24-create-fork.png)
*`username.github.io` 형식으로 `Repository name` 설정 > `Create fork`*

![25-change-repo-name](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/25-change-repo-name.png)
*fork한 repository > `Settings` > `General` > `Default branch`를 `master`에서 `main`으로 변경*

![26-copy-repo-url](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/26-copy-repo-url.png)
...
![27-bundle-install](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/27-bundle-install.png)
...
![28-npm-install-&&-npm-run-build](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/28-npm-install-&&-npm-run-build.png)
...
![29-bundle-exec-jekyll-serve](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/29-bundle-exec-jekyll-serve.png)
...
![30-access-server-address](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/30-access-server-address.png)
...
![31-check-workflows](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/31-check-workflows.png)

fork한 repository > `All workflows` > `Actions`

위 사진과 같은 초록색 체크 표시는 빌드, 배포에 성공했다는 뜻입니다.

![32-check-page-deployment](/assets/img/posts/tools/github/make-github-blog-with-jekyll-chipry-on-windows/32-check-page-deployment.png)
