...
tags: [알고리즘, 프로그래머스, SQL, Oracle, 오라클, 레벨4]
---
...
![보호소에서 중성화한 동물(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/보호소에서-중성화한-동물(1).png)
![보호소에서 중성화한 동물(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/보호소에서-중성화한-동물(2).png)
![보호소에서 중성화한 동물(3)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/보호소에서-중성화한-동물(3).png)
...
![식품분류별 가장 비싼 식품의 정보 조회하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/식품분류별-가장-비싼-식품의-정보-조회하기(1).png)
![식품분류별 가장 비싼 식품의 정보 조회하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/식품분류별-가장-비싼-식품의-정보-조회하기(2).png)
...
![5월 식품들의 총매출 조회하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/5월-식품들의-총매출-조회하기(1).png)
![5월 식품들의 총매출 조회하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/5월-식품들의-총매출-조회하기(2).png)
...
![취소되지 않은 진료 예약 조회하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/취소되지-않은-진료-예약-조회하기(1).png)
![취소되지 않은 진료 예약 조회하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/취소되지-않은-진료-예약-조회하기(2).png)
![취소되지 않은 진료 예약 조회하기(3)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/취소되지-않은-진료-예약-조회하기(3).png)
...
![년, 월, 성별 별 상품 구매 회원 수 구하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/년,-월,-성별-별-상품-구매-회원-수-구하기(1).png)
![년, 월, 성별 별 상품 구매 회원 수 구하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/년,-월,-성별-별-상품-구매-회원-수-구하기(2).png)
...
![서울에 위치한 식당 목록 출력하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/서울에-위치한-식당-목록-출력하기(1).png)
![서울에 위치한 식당 목록 출력하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/서울에-위치한-식당-목록-출력하기(2).png)
...
![우유와 요거트가 담긴 장바구니(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/우유와-요거트가-담긴-장바구니(1).png)
![우유와 요거트가 담긴 장바구니(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/우유와-요거트가-담긴-장바구니(2).png)
...
![저자 별 카테고리 별 매출액 집계하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/저자-별-카테고리-별-매출액-집계하기(1).png)
![저자 별 카테고리 별 매출액 집계하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/저자-별-카테고리-별-매출액-집계하기(2).png)
![저자 별 카테고리 별 매출액 집계하기(3)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/저자-별-카테고리-별-매출액-집계하기(3).png)
...
![주문량이 많은 아이스크림들 조회하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/주문량이-많은-아이스크림들-조회하기(1).png)
![주문량이 많은 아이스크림들 조회하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/주문량이-많은-아이스크림들-조회하기(2).png)
![주문량이 많은 아이스크림들 조회하기(3)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/주문량이-많은-아이스크림들-조회하기(3).png)
...
![주문량이 많은 아이스크림들 조회하기(4)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/주문량이-많은-아이스크림들-조회하기%284%29.png)
...
![그룹별 조건에 맞는 식당 목록 출력하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/그룹별-조건에-맞는-식당-목록-출력하기(1).png)
![그룹별 조건에 맞는 식당 목록 출력하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/그룹별-조건에-맞는-식당-목록-출력하기(2).png)
...
![오프라인/온라인 판매 데이터 통합하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/오프라인-온라인-판매-데이터-통합하기(1).png)
![오프라인/온라인 판매 데이터 통합하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/오프라인-온라인-판매-데이터-통합하기(2).png)
...
![입양 시각 구하기(2)(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/입양-시각-구하기(2)(1).png)
![입양 시각 구하기(2)(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/입양-시각-구하기(2)(2).png)
...
![특정 기간동안 대여 가능한 자동차들의 대여비용 구하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/특정-기간동안-대여-가능한-자동차들의-대여비용-구하기(1).png)
![특정 기간동안 대여 가능한 자동차들의 대여비용 구하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/특정-기간동안-대여-가능한-자동차들의-대여비용-구하기(2).png)
![특정 기간동안 대여 가능한 자동차들의 대여비용 구하기(3)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/특정-기간동안-대여-가능한-자동차들의-대여비용-구하기(3).png)
...
![자동차 대여 기록 별 대여 금액 구하기(1)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/자동차-대여-기록-별-대여-금액-구하기(1).png)
![자동차 대여 기록 별 대여 금액 구하기(2)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/자동차-대여-기록-별-대여-금액-구하기(2).png)
![자동차 대여 기록 별 대여 금액 구하기(3)](/assets/img/posts/algorithm/programmers/sql/oracle/level-4/자동차-대여-기록-별-대여-금액-구하기(3).png)
