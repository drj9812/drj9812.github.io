...
![01-requirement](/assets/img/posts/study/spring-boot/using-spring-boot-and-jpa/domain-analysis-design/01-requirement.jpg)
*요구사항*
...
![02-domain-model](/assets/img/posts/study/spring-boot/using-spring-boot-and-jpa/domain-analysis-design/02-domain-model.jpg)
*도메인 모델*
...
![03-entity](/assets/img/posts/study/spring-boot/using-spring-boot-and-jpa/domain-analysis-design/03-entity.jpg)
*Entity*
...
![04-table](/assets/img/posts/study/spring-boot/using-spring-boot-and-jpa/domain-analysis-design/04-table.jpg)
*Table*
...
> 엔티티의 식별자는 ID를 사용하고 PK 컬럼명은 member_id 를 사용했다. `Entity`는 타입(여기서는 Member )이 있으므로 ID 필드만으로 쉽게 구분할 수 있다. 테이블은 타입이 없으므로 구분이 어렵다. 그리고 테이블은 관례상 테이블명 + ID 를 많이 사용한다. 참고로 객체에서 ID 대신에 memberId 를 사용해도 된다. 중요한 것은 일관성이다.
{: .prompt-tip }
