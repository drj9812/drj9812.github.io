...
![12-ex-group-by](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/12-ex-group-by.jpg)
*`GROUP BY`*
...
![13-ex-having(1)](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/13-ex-having(1).jpg)
*`HAVING`*
...
![14-ex-having(2)](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/14-ex-having(2).jpg)
...
![15-ex-order-by(1)](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/15-ex-order-by(1).jpg)
*`ORDER BY`*
...
![16-ex-order-by(2)](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/16-ex-order-by(2).jpg)
...
![17-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/17-join.jpg)
...
![18-ex-oracle-equi-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/18-ex-oracle-equi-join.jpg)
*오라클 표준 EQUI `JOIN`
...
![19-ex-self-join(1)](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/19-ex-self-join(1).jpg)
*employees*

![20-ex-self-join(2)](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/20-ex-self-join(2).jpg)
*SELF `JOIN`*
...
![21-ex-using](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/21-ex-using.jpg)
*`USING`*
...
![22-ex-natural-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/22-ex-natural-join.jpg)
*`NATURAL JOIN`*
...
![23-ex-left-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/23-ex-left-outer-join.jpg)

![24-ex-oracle-left-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/24-ex-oracle-left-outer-join.jpg)
*오라클 표준 `LEFT OUTER JOIN`*

![25-ex-ansi-left-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/25-ex-ansi-left-outer-join.jpg)
...
![26-ex-oracle-full-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/26-ex-oracle-full-outer-join.jpg)
*오라클 표준 `FULL OUTER JOIN`*

![27-ex-ansi-full-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basic-and-utilization/sql-basic/27-ex-ansi-full-outer-join.jpg)
