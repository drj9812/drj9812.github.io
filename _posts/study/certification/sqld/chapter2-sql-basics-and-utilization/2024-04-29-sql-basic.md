...
![01-ex-select(1)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/01-ex-select(1).jpg)
...
![02-ex-select(2)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/02-ex-select(2).jpg)
...
![03-ex-select(3)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/03-ex-select(3).jpg)
...
![04-ex-from(4)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/04-ex-from(4).jpg)
...
![05-function-type](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/05-function-type.jpg)
...
|                               함수명                                |                                    함수 기능                              |                         예시                        |                     출력                    |                   설명                  |
|:-------------------------------------------------------------:|:------------------------------------------------------------------:|:----------------------------------------------:|:---------------------------------------:|:------------------------------------:|
|  DECODE(대상, 값1, 반환1, 값2, 반환2, ..., 그외 반환)  |                       대상의 값n이면 반환n 반환                   |      DECODE(manager_id, 100, A, B)      |                 A 또는 B                  |  그외 반환 생략시 `NULL` 반환  |
...
|             COALESCE(대상1, 대상2, ..., 그외 반환)         |                   대상n이 `NULL`이면 대상n 반환                 |                     밑에 참고                    |                 밑에 참고                 |  그외 반환 생략시 `NULL` 반환  |
...
![06-ex-decode()](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/06-ex-decode().jpg)
*`DECODE()`*

![07-ex-coalesce()](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/07-ex-coalesce().jpg)
*`COALESCE()`*

- 인자로 넣은 값이 `NULL`이 아니면 맨 앞의 인자부터 반환

![08-ex-case(1)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/08-ex-case(1).jpg)
*`CASE`*

![09-ex-case(2)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/09-ex-case(2).jpg)
*`CASE`*
...
![10-ex-like](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/10-ex-like.jpg)
*`LIKE`*
...
![11-ex-not](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/11-ex-not.jpg)
*`NOT`*
...
![12-ex-group-by](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/12-ex-group-by.jpg)
*`GROUP BY`*
...
![13-ex-having(1)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/13-ex-having(1).jpg)
*`HAVING`*
...
![14-ex-having(2)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/14-ex-having(2).jpg)
...
![15-ex-order-by(1)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/15-ex-order-by(1).jpg)
*`ORDER BY`*
...
- 컬럼명 또는 별칭이 아닌 `SELECT` 절에 사용된 컬럼의 순번 사용 가능
...
![16-ex-order-by(2)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/16-ex-order-by(2).jpg)
...
![17-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/17-join.jpg)
...
![18-ex-oracle-equi-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/18-ex-oracle-equi-join.jpg)
*오라클 표준 EQUI `JOIN`
...
![19-ex-self-join(1)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/19-ex-self-join(1).jpg)
*employees*

![20-ex-self-join(2)](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/20-ex-self-join(2).jpg)
*SELF `JOIN`*

- 한 테이블 내의 각 행끼리 관계를 갖는 `JOIN` 기법
- 한테이블을 참조할 때마다(필요할 때마다) 명시해야 함
...
![21-ex-using](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/21-ex-using.jpg)
*`USING`*
...
![22-ex-natural-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/22-ex-natural-join.jpg)
*`NATURAL JOIN`*

- 두 테이블 간의 **동일한 이름을 가지는 모든 컬럼들에 대해 EQUI `JOIN`을 수행**
	+ 컬럼 이름과 컬럼 값들이 일치해야 함
- **`USING`, `ON`, `WHERE` 절에서 조건 정의 불가**
- `JOIN`에 사용될 컬럼들은 **데이터 유형이 동일해야 하며 접두사를 사용할 수 없음**
...
- 오라클에서 `JOIN`할 때 `JOIN` 조건을 명시하지 않으면 자동으로 CROSS `JOIN`이 실행되지만, ANSI 표준에서 CROSS `JOIN`을 사용하려면 CROSS `JOIN`을 명시해야 함

### OUTER JOIN

- `INNER JOIN`과 대비되는 `JOIN` 방식
- **`JOIN` 조건에서 동일한 값이 없는 행도 반환할 때 사용**
- 두 테이블 중 한 쪽이 `NULL`을 가지면 EQUI `JOIN`시 출력되지 않지만, `OUTER JOIN`을 사용하면 출력됨
...
![23-ex-left-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/23-ex-left-outer-join.jpg)

![24-ex-oracle-left-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/24-ex-oracle-left-outer-join.jpg)
*오라클 표준 `LEFT OUTER JOIN`*

![25-ex-ansi-left-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/25-ex-ansi-left-outer-join.jpg)
...
![26-ex-oracle-full-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/26-ex-oracle-full-outer-join.jpg)
*오라클 표준 `FULL OUTER JOIN`*

![27-ex-ansi-full-outer-join](/assets/img/posts/study/certification/sqld/chapter2-sql-basics-and-utilization/sql-basic/27-ex-ansi-full-outer-join.jpg)
