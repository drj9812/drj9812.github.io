...
|:-------:|:--------------------------:|:-------------------------------------------------:|:---------:|:----------------------:|:--------------------:|
| 1과목 | 데이터 모델링의 이해 | 데이터 모델링의 이해, 데이터 모델과 성능 |     10    |  20점(문항별 2점)  | 90분(1시간 30분) |
...
![notation-entity-and-instance](/assets/img/posts/study/license/01-notation-entity-and-instance.jpg)

- Entity는 사각형으로 표현
- 속성은 조금씩 다름

![notation-entity](/assets/img/posts/study/license/02-notation-entity.jpg)
...
- **한 Entity의 레코드(인스턴스)까 다른 Entity의 레코드(인스턴스)와 어떻게 연결되는지를 나타내는 표현
...
![03-ie-notation](/assets/img/posts/study/license/sqld/03-ie-notation.jpg)

#### Barker 표기법

![04-barker-notation](/assets/img/posts/study/license/sqld/04-barker-notation.jpg)
...
- [[SQLD \| 2과목]SQL 기본 및 활용](https://drj9812.github.io/posts/web-layer-development){: target="_blank" }
