...
- 객체 지향적인 쿼리 언어
	+ JPQL은 데이터베이스의 테이블이 아닌 엔티티 객체를 대상으로 쿼리를 작성
- 플랫폼 독립적
...
- 엔티티 이름과 엔티티 속성의 이름은 대소문자를 구분
	+ UserEntity와 userentity는 다른 취급
- JPQL 키워드는 대소문자를 구분하지 않음
- 데이터베이스의 테이블이 아닌 엔티티 이름을 사용
- 별칭 사용이 필수
- 별칭(as) 생략 가능
...
![01-insert](/assets/img/posts/study/jpql/01-insert.png)
*insert*

![02-insert-result](/assets/img/posts/study/jpql/02-insert-result.png)
*insert 실행 결과*

![03-select](/assets/img/posts/study/jpql/03-select.png)
*select*

![04-list](/assets/img/posts/study/jpql/04-list.png)
*list*

![05-update](/assets/img/posts/study/jpql/05-update.png)
*update*

![06-update-result](/assets/img/posts/study/jpql/06-update-result.png)
*update 실행 결과*

![07-delete](/assets/img/posts/study/jpql/07-delete.png)
*delete*

![08-delete-result](/assets/img/posts/study/jpql/08-delete-result.png)
*delete 실행 결과*
