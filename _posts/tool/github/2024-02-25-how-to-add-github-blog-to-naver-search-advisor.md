...
![04-download-html-file](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/05-download-html-file.jpg)
*HTML 파일 다운로드*

![06-move-html-file](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/06-move-html-file.jpg)
...
![07-verify-ownership(1)](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/07-verify-ownership(1).jpg)
*소유확인*

![08-verify-ownership(2)](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/08-verify-ownership(2).jpg)
*확인*

![09-click-url](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/09-click-url.jpg)
*등록된 사이트 클릭*
...
![10-not-valid-rss](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/10-not-valid-rss.jpg)
...
![11-generate-rss(1)](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/11-generate-rss(1).jpg)
...
![12-generate-rss(2)](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/12-generate-rss(2).jpg)
*코드 복사*

![13-generate-rss(3)](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/13-generate-rss(3).jpg)
*루트 디렉토리에 `rss.xml` 파일 생성 > 편집기를 사용하여 생성한 `rss.xml` 파일에 복사한 코드 붙여넣기*

> Atom 형식으로 작성된 기존의 `feed.xml` 파일은 나중에 쓰일 수도 있으니 굳이 삭제하지 않았습니다.
{: .prompt-tip }

![14-generate-rss(4)](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/14-generate-rss(4).jpg)
*코드 복사*

![15-generate-rss(5)](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/15-generate-rss(5).jpg)
...
![16-submit-rss](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/16-submit-rss.jpg)
*`요청` > `RSS 제출` > https://username.github.io/rss.xml 입력 > `확인`*

### 사이트맵 제출

![17-submit-sitemap](/assets/img/posts/tool/github/how-to-add-github-blog-to-naver-search-advisor/17-submit-sitemap.jpg)
